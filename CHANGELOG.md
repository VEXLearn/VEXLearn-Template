...
VEXLearn uses Semantic Versioning for template releases. Guide versions are tracked separately.
...
- Removed the duplicated `moveRPM()` and `turnRPM()` APIs.
...
- Corrected typos and grammatical issues throughout the template.
- Improved instructional comments and troubleshooting guidance for clarity and consistency.
